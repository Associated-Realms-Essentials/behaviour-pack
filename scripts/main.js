...
ms.system.runInterval(() => {
    ...
    ms.world.getPlayers().forEach(player => {
        if (player.dimension.id == 'minecraft:overworld') {
            if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:bottomBedrock:overworld')?.getParticipants()[0]?.displayName)
                return;
            if (ms.world.scoreboard.getObjective('dirtletsEssentials:bottomBedrock:overworld').getParticipants()[0].displayName == "true") {
            ...
            if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:bottomBedrock:overworld')?.getParticipants()[0]?.displayName)
                return;
            if (ms.world.scoreboard.getObjective('dirtletsEssentials:bottomBedrock:nether').getParticipants()[0].displayName == "true") {
    ...
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:closeRealm:enabled')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:closeRealm:enabled', 'dirtletsEssentials:closeRealm:enabled');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "false" "dirtletsEssentials:closeRealm:enabled" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:closeRealm:reason')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:closeRealm:reason', 'dirtletsEssentials:closeRealm:reason');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:closeRealm:reason" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:command:nuke')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:command:nuke', 'dirtletsEssentials:command:nuke');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:command:nuke" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:adminTag')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:adminTag', 'dirtletsEssentials:save:adminTag');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:save:adminTag" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:chat')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:chat', 'dirtletsEssentials:save:chat');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:joinMessages:enabled')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:joinMessages:enabled', 'dirtletsEssentials:joinMessages:enabled');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "true" "dirtletsEssentials:joinMessages:enabled" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:joinMessages:text')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:joinMessages:text', 'dirtletsEssentials:joinMessages:text');
        ms.world.getDimension('overworld').runCommand('scoreboard players set "§l§3Everyone Welcome §e[player]§3 to §6The Realm§r" "dirtletsEssentials:joinMessages:text" 0');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:jukeboxPlus:enabled')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:jukeboxPlus:enabled', 'dirtletsEssentials:jukeboxPlus:enabled');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "true" "dirtletsEssentials:jukeboxPlus:enabled" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:bottomBedrock:overworld')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:bottomBedrock:overworld', 'dirtletsEssentials:bottomBedrock:overworld');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "true" "dirtletsEssentials:bottomBedrock:overworld" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:bottomBedrock:nether')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:bottomBedrock:nether', 'dirtletsEssentials:bottomBedrock:nether');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "true" "dirtletsEssentials:bottomBedrock:nether" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:association')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:association', 'dirtletsEssentials:save:association');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "Realm Essentials" "dirtletsEssentials:save:association" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:inventorys')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:inventorys', 'dirtletsEssentials:save:inventorys');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:buildAll')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:buildAll', 'dirtletsEssentials:save:buildAll');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "true" "dirtletsEssentials:save:buildAll" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:buildPeople')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:buildPeople', 'dirtletsEssentials:save:buildPeople');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:mutedPeople')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:mutedPeople', 'dirtletsEssentials:save:mutedPeople');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:command:lawn')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:command:lawn', 'dirtletsEssentials:command:lawn');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:command:lawn" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:lockchest')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:lockchest', 'dirtletsEssentials:save:lockchest');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:save:lockchest" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:blocklogs')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:blocklogs', 'dirtletsEssentials:save:blocklogs');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:blocklogsenabled')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:blocklogsenabled', 'dirtletsEssentials:save:blocklogsenabled');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "true" "dirtletsEssentials:save:blocklogsenabled" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:floatingtextguidata')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:floatingtextguidata', 'dirtletsEssentials:save:floatingtextguidata');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:save:floatingtextguidata" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:fillWand:coordsSet1')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:fillWand:coordsSet1', 'dirtletsEssentials:fillWand:coordsSet1');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:fillWand:coordsSet1" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:fillWand:coordsSet2')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:fillWand:coordsSet2', 'dirtletsEssentials:fillWand:coordsSet2');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:fillWand:coordsSet2" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:fillWand:player')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:fillWand:player', 'dirtletsEssentials:fillWand:player');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:fillWand:player" 0`);
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:fillWand:block')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:fillWand:block', 'dirtletsEssentials:fillWand:block');
        ms.world.getDimension('overworld').runCommand(`scoreboard players set "" "dirtletsEssentials:fillWand:block" 0`);
    }
    // if(!ms.world.scoreboard.getObjective('dirtletsEssentials:save:mail')){
    //     ms.world.scoreboard.addObjective('dirtletsEssentials:save:mail', 'dirtletsEssentials:save:mail');
    // }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:accesslogs')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:accesslogs', 'dirtletsEssentials:save:accesslogs');
    }
    if (!ms.world.scoreboard.getObjective('dirtletsEssentials:save:playerReports')) {
        ms.world.scoreboard.addObjective('dirtletsEssentials:save:playerReports', 'dirtletsEssentials:save:playerReports');
    }
    if ((ms?.world?.scoreboard?.getObjective('dirtletsEssentials:save:chat')?.getParticipants()?.length / 20) >= 100) {
        ms.world.scoreboard.removeObjective('dirtletsEssentials:save:chat');
    }
    if (ms?.world?.scoreboard?.getObjective('dirtletsEssentials:save:adminTag')?.getParticipants()) {
        if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:save:association')?.getParticipants()[0]?.displayName)
            return;
        ms.world.getPlayers().forEach(player => {
            ...
            if (player.hasTag(adminTag)) {
                ...
                ms.world.scoreboard.getObjective('dirtletsEssentials:save:adminTag').getParticipants().forEach(playerInDB => {
                ...
                if (areTheyInTheDB == false) {
                    ...
                    player.dimension.runCommand(`scoreboard players set "${player.name}" "dirtletsEssentials:save:adminTag" 0`);
                    // Wait a sec, we can just say to then you now have admin!
                    player.dimension.runCommand(`
                        tellraw @a[tag="${adminTag}"] {"rawtext":[{"text":"\n§l§f§2${ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName}§r§l§a >> §r§l§e${player.name} §6is now a admin.§r"}]}
                    `);
                }
                return;
            }
            ms.world.scoreboard.getObjective('dirtletsEssentials:save:adminTag').getParticipants().forEach(playerInDB => {
                if (playerInDB.displayName == player.name) {
                    ...
                    player.dimension.runCommand(`scoreboard players reset "${player.name}" "dirtletsEssentials:save:adminTag"`);
                    // Wait a sec, we can just say to then you have have been revoked as a admin!
                    player.dimension.runCommand(`
                        tellraw @a[tag="${adminTag}"] {"rawtext":[{"text":"\n§l§f§2${ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName}§r§l§a >> §r§l§e${player.name} §6has been revoked as a admin.§r"}]}
                    `);
                    player.dimension.runCommand(`
    ...
    if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:closeRealm:enabled')?.getParticipants()[0]?.displayName)
        return;
    if (ms.world.scoreboard.getObjective('dirtletsEssentials:closeRealm:enabled').getParticipants()[0].displayName == "true") {
        ms.world.getPlayers().forEach(player => {
            if (player.isOp())
                return;
            if (player.hasTag(adminTag))
                return;
            player.dimension.runCommand(`
                kick "${player.name}" "(${ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName}) A Admin closed the realm for: ${ms.world.scoreboard.getObjective('dirtletsEssentials:closeRealm:reason').getParticipants()[0].displayName}"
            `);
        });
    }
}, 1);
// Nuke command
ms.system.runInterval(() => {
    if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:command:nuke')?.getParticipants()[0]?.displayName)
        return;
    if (ms.world.scoreboard.getObjective('dirtletsEssentials:command:nuke').getParticipants()[0].displayName != "") {
        ms.world.getPlayers().forEach(player => {
            if (player.name != ms.world.scoreboard.getObjective('dirtletsEssentials:command:nuke').getParticipants()[0].displayName)
                return;
            player.dimension.runCommand(`
                execute positioned as "${ms.world.scoreboard.getObjective('dirtletsEssentials:command:nuke').getParticipants()[0].displayName}" run summon tnt ~~1~
            `);
            player.dimension.runCommand(`execute as "${ms.world.scoreboard.getObjective('dirtletsEssentials:command:nuke').getParticipants()[0].displayName}" positioned as "${ms.world.scoreboard.getObjective('dirtletsEssentials:command:nuke').getParticipants()[0].displayName}" run kill @e[type=item, r=20]`);
        });
    }
}, 10);
// Lawn Handler
ms.system.runInterval(() => {
    if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:command:lawn')?.getParticipants()[0]?.displayName)
        return;
    if (ms.world.scoreboard.getObjective('dirtletsEssentials:command:lawn').getParticipants()[0].displayName != "") {
        ms.world.getPlayers().forEach(player => {
            if (player.name != ms.world.scoreboard.getObjective('dirtletsEssentials:command:lawn').getParticipants()[0].displayName)
                return;
            player.runCommand(`
...
function playFromJukeboxThroughSpeakers(jukeboxCoordinates, dimension, songToPlay) {
    ...
    if (block?.typeId?.includes('jukebox')) {
        if (!ms?.world?.scoreboard?.getObjective('dirtletsEssentials:jukeboxPlus:enabled')?.getParticipants()[0]?.displayName)
            return;
        if (ms.world.scoreboard.getObjective('dirtletsEssentials:jukeboxPlus:enabled').getParticipants()[0].displayName != "true")
            return;
        if (songToPlay) {
            if (oldSong != null) {
            ...
            //     ms.system.run(() => {
            //         player.dimension.runCommand(`
            //             tellraw @a[tag="${adminTag}"] {"rawtext":[{"text":"§l§f§2${ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName}§r§l§a >> §r§l§aEnjoy the music §2${player.name}!§r"}]}
            //         `)
            //     })
            // return}
            // ms.system.run(() => {
            ...
            //     `)
            //     player.dimension.runCommand(`
            //         tellraw "${player.name}" {"rawtext":[{"text":"§l§f§2${ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName}§r§l§a >> §r§l§aEnjoy the music §2${player.name}!§r"}]}
            //     `)
            // })
        }
    }
                ...
                ms.system.run(async () => {
                    try {
                        ...
                        if (tagContent.includes('::')) {
                            ...
                            if (arrayOfData[0]) {
                                title = arrayOfData[0].replaceAll("{newline}", "\n").replaceAll("{user}", player.name).replaceAll("{association}", ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName);
                            }
                            if (arrayOfData[1]) {
                            ...
                            if (arrayOfData[4]) {
                                commandForButton1 = arrayOfData[4].replaceAll("{q}", "\"").replaceAll("{user}", player.name).replaceAll("{association}", ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName);
                                if (commandForButton1.includes("||"))
                                    commandForButton1 = commandForButton1.split("||");
                            }
                            if (arrayOfData[5]) {
                                commandForButton2 = arrayOfData[5].replaceAll("{q}", "\"").replaceAll("{user}", player.name).replaceAll("{association}", ms.world.scoreboard.getObjective('dirtletsEssentials:save:association').getParticipants()[0].displayName);
