    ...
    ms.system.run(() => {
        ...
        if (chatMessage.sender.hasTag(adminTag)) {
            if (!args[1]) {
                ...
                ms.world.scoreboard.getObjective('associatedRealmsEssentials:save:accesslogs').getParticipants().forEach(accessLogs => {
                ...
                ms.system.run(() => {
                    ms.world.scoreboard.removeObjective('associatedRealmsEssentials:save:accesslogs');
