...
§l§6${ms.world.scoreboard.getObjective('associatedRealmsEssentials:save:association').getParticipants()[0].displayName} §eHelp§r
...
>adminui - Shows the Admin UI were you can configure associated realm essentials.
